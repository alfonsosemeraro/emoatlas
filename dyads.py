...
def _outer_border(ax, dyad_score, color, angle, highlight, offset = .15, height_width_ratio = 1, rescale = False):
    """
...
def _petal_shape_dyad(ax, dyad_score, colorA, colorB, angle, font, fontweight, fontsize, highlight, will_circle, offset = .15, height_width_ratio = 1, rescale = False):
    """
    Draw a petal.
...
def _draw_dyad_petal(ax, dyad, dyad_score, highlight, font, fontweight, fontsize, show_coordinates, height_width_ratio, reject_range, offset = .15, rescale = False):
    """
    ...
    *rescale*:
    ...
    ax = _petal_shape_dyad(ax, dyad_score, colorA, colorB, angle, font, fontweight, fontsize, height_width_ratio = height_width_ratio, highlight = highlight, will_circle = False, rescale = rescale)
    # Draw border
    _outer_border(ax, dyad_score, colorA, angle, height_width_ratio = height_width_ratio, highlight = 'all', rescale = rescale)
